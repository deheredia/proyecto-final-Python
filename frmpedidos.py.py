...
class App:
    def __init__(self, root):
        ...
        GLabel_426["text"] = "Fecha de Pedido"
        GLabel_426.place(x=20,y=60,width=82,height=30)
        ...
        GButton_550.place(x=200,y=250,width=72,height=30)
        ...
        GButton_101.place(x=290,y=250,width=69,height=30)
